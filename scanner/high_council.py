...
async def process_observations():
    ...
    system_instruction = (
        ...
        "ПРАВИЛО 2 (МГНОВЕННАЯ МОБИЛИЗАЦИЯ): Каждое новое донесение от разведчика (NEW_OBSERVATIONS) должно быть немедленно отображено на карте. "
        "Не жди доп. подтверждений, твоя задача — обеспечить МАКСИМАЛЬНУЮ скорость отображения угрозы. "
        "Если в CURRENT_TARGETS цели нет, создавай её под новым ID.\n"
